...
wallf.savefig("at_t_comparison_wall.eps",format = "eps")

varf.savefig("at_t_comparison_variance_png.png",format = "png")
cpuf.savefig("at_t_comparison_cpu_png.png",format = "png")
wallf.savefig("at_t_comparison_wall_png.png",format = "png")

npsave("at_t_comparison_variance.npy",s_var)
npsave("at_t_comparison_cpu.npy",s_cpu)
npsave("at_t_comparison_wall.npy",s_wall)