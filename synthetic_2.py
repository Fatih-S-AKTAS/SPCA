...
from datagenerator import varimax_paper_data_mk2
#%%
...
progress = open("synthetic2_progress.txt","w")
try:
    for iteration in range(0,up_to):
        for rep in range(repeat):
            s = 8 + iteration
            A = varimax_paper_data_mk2(10 + iteration * 2,s, 100 + iteration * 20)
...
varf.savefig("synthetic2_variance.eps",format = "eps")
cpuf.savefig("synthetic2_cpu.eps",format = "eps")
wallf.savefig("synthetic2_wall.eps",format = "eps")

varf.savefig("synthetic2_variance_png.png",format = "png")
cpuf.savefig("synthetic2_cpu_png.png",format = "png")
wallf.savefig("synthetic2_wall_png.png",format = "png")

npsave("synthetic2_variance.npy",s_var)
npsave("synthetic2_cpu.npy",s_cpu)
npsave("synthetic2_wall.npy",s_wall)
