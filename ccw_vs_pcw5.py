...
progress = open("ccw5_pcw_progress.txt","w")
try:
...
wallf.savefig("CW5_comparison_wall.eps",format = "eps")

varf.savefig("CW5_comparison_variance_png.png",format = "png")
cpuf.savefig("CW5_comparison_cpu_png.png",format = "png")
wallf.savefig("CW5_comparison_wall_png.png",format = "png")

npsave("CW5_comparison_variance.npy",s_var)
npsave("CW5_comparison_cpu.npy",s_cpu)
npsave("CW5_comparison_wall.npy",s_wall)
