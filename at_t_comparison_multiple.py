...
varf.savefig("at_t_comparison_multiple_variance.eps",format = "eps")
cpuf.savefig("at_t_comparison_multiple_cpu.eps",format = "eps")
wallf.savefig("at_t_comparison_multiple_wall.eps",format = "eps")

varf.savefig("at_t_comparison_multiple_variance_png.png",format = "png")
cpuf.savefig("at_t_comparison_multiple_cpu_png.png",format = "png")
wallf.savefig("at_t_comparison_multiple_wall_png.png",format = "png")

npsave("at_t_comparison_multiple_variance.npy",s_var)
npsave("at_t_comparison_multiple_cpu.npy",s_cpu)
npsave("at_t_comparison_multiple_wall.npy",s_wall)