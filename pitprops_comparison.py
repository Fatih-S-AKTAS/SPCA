...
s_var = zeros([repeat,up_to-1,9])
s_cpu = zeros([repeat,up_to-1,9])
s_wall = zeros([repeat,up_to-1,9])
...
for rep in range(repeat):
    ...
    for iteration in range(0,up_to - 1):
        ...
        optimum[iteration] = omega.eigenvalues[iteration]/lambda_max
...
legend(["GD","CCW","FCW","EM","Path","GPower","PCW","GCW","GPBB-ls","Optimum"])
xlabel("Sparsity")
ylabel("Variance")
...
wallf.savefig("pitprops_comparison_wall.eps",format = "eps")

varf.savefig("pitprops_comparison_variance_png.png",format = "png")
cpuf.savefig("pitprops_comparison_cpu_png.png",format = "png")
wallf.savefig("pitprops_comparison_wall_png.png",format = "png")

npsave("pitprops_comparison_variance.npy",s_var)
npsave("pitprops_comparison_cpu.npy",s_cpu)
npsave("pitprops_comparison_wall.npy",s_wall)