...
from numpy import arange,shape,zeros,array
...
sss_var = zeros([up_to-1,7])
sss_cpu = zeros([up_to-1,7])
...
tss_cpu = s_cpu+ss_cpu
tsss_cpu = s_cpu+sss_cpu
...
legend(["GD","CCW","FCW","EM","Path","GPower","Greedy","Optimum"])
xlabel("Sparsity")
ylabel("Variance")
...
plot(sparsity,tss_cpu[:,6],color = "cyan")
legend(["GD","CCW","FCW","EM","Path","GPower","PCW"])
xlabel("Sparsity")
ylabel("CPU time (s)")
title("CPU time Against Sparsity Level Imposing Stationarity")
...
plot(sparsity,sss_var[:,6],color = "cyan")
plot(sparsity,optimum,color = "black")
...
cpuf3 = figure()
grid(True)
plot(sparsity,tsss_cpu[:,0],color = "blue")
plot(sparsity,tsss_cpu[:,1],color = "red")
plot(sparsity,tsss_cpu[:,2],color = "green")
plot(sparsity,tsss_cpu[:,3],color = "olive")
plot(sparsity,tsss_cpu[:,4],color = "orange")
plot(sparsity,tsss_cpu[:,5],color = "purple")
plot(sparsity,tsss_cpu[:,6],color = "cyan")
legend(["GD","CCW","FCW","EM","Path","GPower","PCW"])
xlabel("Sparsity")
ylabel("CPU time (s)")
title("Total CPU time Against Sparsity Level")
